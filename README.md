...
The file flu-shot-learning.ipynb contains my work as of 2025-03-02 using the `GradientBoostingClassifier` algorithm. The highest AUROC score achieved with this file is 0.8452, at rank #987 out of ~7000.
